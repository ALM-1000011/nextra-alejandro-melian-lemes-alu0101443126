...
![Formulario de búsqueda](enlace-imagen-aqui)
...
Con esta práctica se logró crear una aplicación web en Next.js que permite buscar repositorios de GitHub utilizando `getServerSideProps` y rutas dinámicas. La aplicación proporciona una experiencia de usuario fluida y eficiente.
